...
- **Grazing crossing detection** in `routeAroundLand` (`geo.js:336`): when `segmentCrossesPolygon` entry/exit points are < 5 km apart, the polygon is skipped. Prevents tiny zigzag perimeters from small island intersections (Salt Spring Island, Gulf Islands).
